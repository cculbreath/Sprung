...
@Observable class ResumeReviewQuery {
    ...
    func buildContentsFitPrompt() -> String {
        ...
        Instructions:
        1. Look at the Skills and Expertise section in the resume image
        2. Check if any text appears to be cut off at the bottom of the page or section
        3. Look for any visual indicators of content overflow (text running beyond boundaries, partial lines, etc.)
        4. Count approximately how many lines of text appear to be overflowing beyond the intended boundaries
