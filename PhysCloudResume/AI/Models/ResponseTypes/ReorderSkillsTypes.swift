...
extension OverflowSchemas {
    ...
    // Schema for response as an object containing an array (to comply with OpenAI Responses API requirements)
    static let reorderSkillsArraySchemaString = """
    {
      "type": "object",
      "description": "Contains an array of skill or expertise items in the optimal new order.",
      "properties": {
