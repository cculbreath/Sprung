...
struct ResRefView: View {
    ...
    @State var isSourceHovering = false
            ...
            HStack {
                ...
                if !(selRes.hasValidRefsEnabled) {
                    HStack{
                        ...
                        Image(systemName: "exclamationmark.triangle").foregroundColor(.purple).fontWeight(.light).font(.system(size: 20))
                    }
                }
            }
...
struct SourceRowView: View {
    ...
    var body: some View {
        HStack {
            ...
            .cornerRadius(5).onHover { hovering in
                isRowHovering = hovering
            }
    }
}
        ...
        Toggle(
            ...
            isOn: Binding<Bool>(
                ...
                set: { newValue in
                    ...
                    res.enabledSources.map { print($0.name+$0.type.rawValue) } // This should now run when the toggle is changed
                }
            )
        )
        .toggleStyle(.switch)
