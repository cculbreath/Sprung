...
enum CoverLetterPrompts {
    ...
    enum EditorPrompts: String, Codable, CaseIterable {
        ...
        case zinsser =
            "Carefully read the letter as a professional editor, specifically William Zinsser, incorporating the writing techniques and style he advocates in \"On Writing Well.\" Provide a new draft that incorporates Zinsser's edits to improve the quality of the writing."
        case mimic =
