//
//  SearchOpsContextProvider.swift
//  Sprung
//
//  Provides context to LLM tools from SearchOps stores and state.
...
protocol SearchOpsContextProvider: Sendable {
    // Daily Tasks
...
/// Provides context from SearchOpsCoordinator to LLM tools
final class SearchOpsContextProviderImpl: SearchOpsContextProvider, @unchecked Sendable {
    private weak var coordinator: SearchOpsCoordinator?

    init(coordinator: SearchOpsCoordinator) {
