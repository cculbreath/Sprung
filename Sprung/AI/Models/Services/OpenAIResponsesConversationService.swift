...
private extension ToolProperty {
    func asJSONSchema() -> JSONSchema {
        ...
        let allowsAdditionalProperties = schemaType == .object
...
actor OpenAIResponsesConversationService: LLMStreamingConversationService {
    ...
    // MARK: - Onboarding Tool Definitions

    private var onboardingTools: [ToolDefinition] {
        [
            ToolDefinition(
                name: "parse_resume",
                description: "Parse uploaded resume data into structured applicant fields.",
                parameters: ToolParameters(
                    type: "object",
                    properties: [
                        "fileId": ToolProperty(type: "string", description: "ID of the uploaded resume file.")
                    ],
                    required: ["fileId"]
                )
            ),
            ToolDefinition(
                name: "parse_linkedin",
                description: "Extract structured data from a LinkedIn profile page or HTML upload.",
                parameters: ToolParameters(
                    type: "object",
                    properties: [
                        "url": ToolProperty(type: "string", description: "LinkedIn profile URL."),
                        "fileId": ToolProperty(type: "string", description: "Optional local LinkedIn HTML file.")
                    ],
                    required: []
                )
            ),
            ToolDefinition(
                ...
                description: "Summarize supporting materials such as projects, papers, or presentations.",
                parameters: ToolParameters(
                    type: "object",
                    properties: [
                        "fileId": ToolProperty(type: "string", description: "Artifact file ID."),
                        "context": ToolProperty(type: "string", description: "Optional context for the summary.")
                    ],
                    required: ["fileId"]
                )
            ),
            ToolDefinition(
                name: "web_lookup",
                description: "Perform a verified external lookup to confirm details or gather context. Only allowed when user consent is granted.",
                parameters: ToolParameters(
                    type: "object",
                    properties: [
                        "query": ToolProperty(type: "string", description: "Search query string."),
                        "context": ToolProperty(type: "string", description: "Purpose or context of the lookup.")
                    ],
                    required: ["query"]
                )
            ),
            ToolDefinition(
                name: "persist_delta",
                description: "Persist verified schema updates to the applicant profile or artifacts.",
                parameters: ToolParameters(
                    type: "object",
                    properties: [
                        "target": ToolProperty(type: "string", description: "Target schema name."),
                        "value": ToolProperty(type: "object", description: "JSON patch to persist.")
                    ],
    ...
    private var onboardingToolSchemas: [Tool] {
        onboardingTools.map(\.asFunctionTool)
    }
