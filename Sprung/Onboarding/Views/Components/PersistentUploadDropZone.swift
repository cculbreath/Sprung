...
/// Extraction method for large PDFs
enum LargePDFExtractionMethod: String, CaseIterable {
    ...
    var displayName: String {
        switch self {
        case .chunkedNative: return "Native PDF (chunked)"
    ...
    var description: String {
        switch self {
        case .chunkedNative: return "Best quality - sends PDF chunks to AI"
        case .textExtract: return "Faster - extracts text first"
        }
    }
}
