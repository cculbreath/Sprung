...
class CandidateDossier: Identifiable, Codable {
    ...
    required init(from decoder: Decoder) throws {
        ...
        careerThroughLines = try container.decodeIfPresent(String.self, forKey: .careerThroughLines)
    }
    ...
    func encode(to encoder: Encoder) throws {
        ...
        try container.encodeIfPresent(careerThroughLines, forKey: .careerThroughLines)
    }
    // MARK: - Identity
    ...
    // MARK: - Career Synthesis (Cross-Cutting Narrative)

    /// A rich, evidence-grounded prose portrait of the candidate's career
    /// through-lines — the recurring patterns and connective tissue that no
    /// single knowledge card captures alone. Generated by CareerSynthesisService
    /// by reading across all knowledge cards, the skill bank, and the dossier;
    /// regenerable from the onboarding debug panel. Flows into resume
    /// customization and seed generation as positioning fuel. Free narrative —
    /// deliberately not a fixed schema. Safe to export (no private details).
    var careerThroughLines: String?
    ...
    init(
        ...
        self.careerThroughLines = careerThroughLines
    }
