...
- [x] Milestone 3 – SwiftOpenAI Logging Levels
...
- 2025-10-31: Finished Milestone 3 by adding configurable log levels (quiet/info/verbose/debug) in `SwiftOpenAIClient`, filtering per-token deltas to debug-only output.
